...
import { User, Bell, Lock, Sparkles, Moon, Sun, Shield, Download, Upload, Trash, Globe } from 'lucide-react';
          ...
          <div className="space-y-2">
            ...
            <div className="flex gap-2">
              ...
              <Button size="sm" onClick={() => {
                if (!apiUrl.trim()) {
                  toast.error('API Server URL cannot be empty');
                  return;
                }
                api.setApiBase(apiUrl.trim());
                toast.success('Cloud Server URL updated successfully');
              }}>Save URL</Button>
            </div>
